...
// 2. Выделение 12-го символа в строке s1 и определение его ASCII-кода
$char_12_s1 = mb_substr($s1, 11, 1, 'UTF-8'); 
$ascii_code = ord($char_12_s1);
echo "12-й символ в строке s1: $char_12_s1, его ASCII-код: $ascii_code<br>";
